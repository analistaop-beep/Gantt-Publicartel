    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {teams.map((team) => {
                    return (
                        <div key={team.id} className="glass p-6 rounded-3xl space-y-4 group">
            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="glass p-8 rounded-[2rem] w-full max-w-2xl max-h-[90vh] overflow-auto space-y-6">
